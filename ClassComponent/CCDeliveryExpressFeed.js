...
const CONTENT = [
  {
    isExpanded: false,
    category_name: 'משלוח #255',
    subcategory: [
      { id: 1, val: 'איסוף : תל אביב השלום' },
      { id: 2, val: 'מספר לוקר : 1548' },
      { id: 3, val: 'משקל : 3 עד 6 קג' },
      { id: 4, val: 'כתובת : רחוב אלנבי 13' },
      { id: 5, val: 'פרטי קשר: 0526222974' },
